...
public class MDES
{
    ...
    public static void main (String args[])
    {
        ...
        MDES mdesObj = new MDES();

        System.out.println("MDES Encryption: ");
        ...
        for (int i = 0; i < key.length; i++)
        {
            ...
            for (int j = 0; j < data.length; j++)
            {
                ...
                // LDES Encryption
                cText = mdesObj.nonLinearDESEncrypt(inData, k);
                
                // Printing 4-bit encrypted output
                for (int m = 0; m < 1; m++)
                {
                    mdesObj.bitPattern(cText, 4);
                }
                System.out.print(" ");
            }
            System.out.println();
        ...
        for (int i = 0; i < key.length; i++)
        {
            ...
            for (int j = 0; j < data.length; j++)
            {
                ...
                // LDES Encryption
                cText = mdesObj.nonLinearDESDecrypt(inData, k);
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            for (int j = 0; j < 1; j++)
            {
                cText = mdesObj.nonLinearDESEncrypt(tempData[0], k);
                mdesObj.bitPattern(cText, 4);   

                System.out.print(" = ");

                cText = mdesObj.nonLinearDESEncrypt(tempData[1], k);
                mdesObj.bitPattern(cText, 4);

                System.out.print(" ^ ");

                cText = mdesObj.nonLinearDESEncrypt(tempData[2], k);
                mdesObj.bitPattern(cText, 4);

                System.out.print(" ^ ");

                cText = mdesObj.nonLinearDESEncrypt(tempData[3], k);
                mdesObj.bitPattern(cText, 4);

                // Verification
                int pText1 = mdesObj.nonLinearDESEncrypt(tempData[1], k);
                int pText2 = mdesObj.nonLinearDESEncrypt(tempData[2], k); 
                int pText3 = mdesObj.nonLinearDESEncrypt(tempData[3], k);
                xorResult = pText1 ^ pText2 ^ pText3;
                pText = mdesObj.nonLinearDESEncrypt(tempData[0], k);
                
                if (pText == xorResult)
                {
                    System.out.print("  ");
                    System.out.print("Verified: ");
                    mdesObj.bitPattern(pText, 4);
                }
            }
            System.out.println();   
        }
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            for (int j = 0; j < 1; j++)
            {
                ...
                cText = mdesObj.nonLinearDESEncrypt(tempData[4], k);
                mdesObj.bitPattern(cText, 4);

                System.out.print(" ^ ");

                cText = mdesObj.nonLinearDESEncrypt(tempData[5], k);
                mdesObj.bitPattern(cText, 4);
                ...
                int pText2 = mdesObj.nonLinearDESEncrypt(tempData[2], k); 
                int pText3 = mdesObj.nonLinearDESEncrypt(tempData[3], k);
                int pText4 = mdesObj.nonLinearDESEncrypt(tempData[4], k);
                int pText5 = mdesObj.nonLinearDESEncrypt(tempData[5], k);
